...
const room_type_schema_1 = require("../../schema/room-type.schema");
let RoomTypeService = class RoomTypeService {
    constructor(dbService) {
        ...
        this.serviceModel =
            ((_a = this.dbService.db()) === null || _a === void 0 ? void 0 : _a.models.Service) ||
                (0, mongoose_1.model)('RoomType', room_type_schema_1.RoomTypeSchema);
    }
    ...
    async findByFilter(filterRoomTypeDTO) {
        const roomTypesResult = await this.serviceModel
            .find(Object.assign(Object.assign({}, filterRoomTypeDTO), { deleted: null }))
            .exec();
        const roomTypes = roomTypesResult.map((u) => u.toJSON());
        return roomTypes;
    }
    ...
    async update(id, updateRoomTypeDTO) {
        await this.serviceModel
            .updateOne({ _id: id }, Object.assign(Object.assign({}, updateRoomTypeDTO), { updated: Date.now() }))
            .exec();
